...
import { AccountBalance, Atm, AdUnits, PeopleOutlined, UploadFile ,settings, Settings} from '@mui/icons-material';
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { title: 'Şube Özet Ekranı', path: PATH_DASHBOARD.user.development},
          { title: "Şubeler", path: PATH_DASHBOARD.user.development },
          { title: 'Şube Tanımları', path: PATH_DASHBOARD.user.development },
        ],
      },
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      // USER
      {
        ...
        icon: ICONS.settings,
        children: [
          { title: 'Varsayılan atm ayarları', path: PATH_DASHBOARD.user.development},
          { title: "varsayılan şube ayarları", path: PATH_DASHBOARD.user.development },
          { title: ' Sistem ayarları', path: PATH_DASHBOARD.user.development },
        ],
        // children: [
        //   { title: 'Ayarlar', path: PATH_DASHBOARD.user.profile },
